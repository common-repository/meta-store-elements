...
class Meta_Store_Product_List_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .ms-product-list .product-list li .product-image' => 'width: {{SIZE}}{{UNIT}}; flex: 0 0 {{SIZE}}{{UNIT}}',
            ]
                ]
        );
    ...
    protected function render() {
        ...
        $image_size = $settings['image_size_size'] ? $settings['image_size_size'] : 'woocommerce_thumbnail';
